        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <x-adminlte-card title="Orang Tua / Wali Murid" theme="dark" collapsible="collapsed">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $orangTua->pendidikan_ayah == 'Tidak Sekolah' && $orangTua->nama_ayah == null ? '-' : $orangTua->pendidikan_ayah }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Pendidikan Ibu</td>
                                <td width="3%">:</td>
                                <td>{{ $orangTua->pendidikan_ibu == 'Tidak Sekolah' && $orangTua->nama_ibu == null ? '-' : $orangTua->pendidikan_ibu }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $orangTua->pendidikan_wali == 'Tidak Sekolah' && $orangTua->nama_wali == null ? '-' : $orangTua->pendidikan_wali }}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <x-adminlte-card title="Perkembangan Siswa" theme="dark" collapsible="collapsed">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $progresSiswa->asal_sekolah_pindah == null ? '-' : $progresSiswa->asal_sekolah_pindah }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Tingkat Sekolah (Pindah)</td>
                                <td width="3%">:</td>
                                <td>{{ $progresSiswa->asal_sekolah_pindah == null && $progresSiswa->tingkat_sekolah_pindah == '1' ? '-' : $progresSiswa->tingkat_sekolah_pindah }}
                                </td>
                            </tr>
                            <tr>
                    ...
                    <x-adminlte-card title="Meninggalkan Sekolah" theme="dark" collapsible="collapsed">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->thn_tamat == null ? '-' : $meninggalkanSekolah->thn_tamat }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Nomor Ijazah / STTB</td>
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->no_ijazah == null ? '-' : $meninggalkanSekolah->no_ijazah }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Melanjutkan Ke Sekolah</td>
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->lanjut_sekolah_tamat == null ? '-' : $meninggalkanSekolah->lanjut_sekolah_tamat }}
                                </td>
                            </tr>
                            <tr>
                                <th class="pt-4">
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->lanjut_sekolah_pindah == null && $meninggalkanSekolah->dari_tingkat == '1' ? '-' : $meninggalkanSekolah->dari_tingkat }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Ke Tingkat</td>
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->lanjut_sekolah_pindah == null && $meninggalkanSekolah->ke_tingkat == '1' ? '-' : $meninggalkanSekolah->ke_tingkat }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Ke Sekolah</td>
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->lanjut_sekolah_pindah == null ? '-' : $meninggalkanSekolah->lanjut_sekolah_pindah }}
                                </td>
                            </tr>
                            <tr>
                                <th class="pt-4">
                            ...
                            <tr>
                                ...
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->tgl_keluar_sekolah == null ? '-' : $meninggalkanSekolah->tgl_keluar_sekolah }}
                                </td>
                            </tr>
                            <tr>
                                <td width="30%">Alasan Keluar</td>
                                <td width="3%">:</td>
                                <td>{{ $meninggalkanSekolah->alasan_keluar_sekolah == null ? '-' : $meninggalkanSekolah->alasan_keluar_sekolah }}
                                </td>
                            </tr>
                ...
                @if (auth()->user()->role !== 'admin')
                    <x-adminlte-button class="btn-flat text-light col-md-2 mb-3" onclick="return back_guru();"
                        label="Kembali" theme="primary" icon="fas fa-lg fa-arrow-left" />
                    <br>
                @else
                    <x-adminlte-button class="btn-flat text-light col-md-2 mb-3" onclick="return back();" label="Kembali"
