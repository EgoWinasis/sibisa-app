                ...
                <div class="row">
                    ...
                    <x-adminlte-card title="Tahun Masuk" class="col-md-12" theme-mode="full">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <x-adminlte-input name="angkatan" value="{{ $tahunAjaran->tahun_ajaran }}" 
                                    type="text" readonly>
                                </x-adminlte-input>
                            </div>
                        </div>
                    ...
                    <x-adminlte-card title="Keterangan Siswa" class="col-md-12" theme-mode="full" collapsible="collapsed">
                        <div class="row">
                            ...
                            {{-- Bahasa Sehari hari --}}
                            <x-adminlte-input name="bahasa" value="{{ old('bahasa') }}"
                            ...
                            {{-- Alamat --}}
                            <x-adminlte-input name="alamat" value="{{ old('alamat') }}" label="Alamat"
                            ...
                            {{-- Tempat tinggal --}}
                            <x-adminlte-input name="tempat_tinggal" value="{{ old('tempat_tinggal') }}"
                    ...
                    <x-adminlte-card title="Keterangan Orang Tua / Wali Murid" class="col-md-12" theme-mode="full"
                        ...
                        <div class="row">
                            ...
                            {{-- pekerjaan ayah --}}
                            <x-adminlte-input name="pekerjaan_ayah" value="{{ old('pekerjaan_ayah') }}"
                                label="Pekerjaan Ayah" placeholder="Pekerjaan Ayah" fgroup-class="col-md-6" />
                            {{-- Pekerjaan Ibu --}}
                            <x-adminlte-input name="pekerjaan_ibu" value="{{ old('pekerjaan_ibu') }}"
                            ...
                            {{-- Hubungan wali --}}
                            <x-adminlte-input name="hubungan_wali" value="{{ old('hubungan_wali') }}"
                            ...
                            {{-- pekerjaan Wali --}}
                            <x-adminlte-input name="pekerjaan_wali" value="{{ old('pekerjaan_wali') }}"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="number" min="2000" name="jas_th_1"
                                                        value="{{ old('jas_th_1') }}"></td>
                                                <td><input type="number" min="2000" name="jas_th_2"
                                                        value="{{ old('jas_th_2') }}"></td>
                                                <td><input type="number" min="2000" name="jas_th_3"
                                                        value="{{ old('jas_th_3') }}"></td>
                                                <td><input type="number" min="2000" name="jas_th_4"
                                                        value="{{ old('jas_th_4') }}"></td>
                                                <td><input type="number" min="2000" name="jas_th_5"
                                                        value="{{ old('jas_th_5') }}"></td>
                                                <td><input type="number" min="2000" name="jas_th_6"
                                                        value="{{ old('jas_th_6') }}"></td>
                                            </tr>
                                            <tr>
                                                <th>Berat Badan</th>
                                                <td><input type="number" min="1" name="jas_bb_1"
                                                        value="{{ old('jas_bb_1') }}" placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_2"
                                                        value="{{ old('jas_bb_2') }}" placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_3"
                                                        value="{{ old('jas_bb_3') }}" placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_4"
                                                        value="{{ old('jas_bb_4') }}" placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_5"
                                                        value="{{ old('jas_bb_5') }}" placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_6"
                                                        value="{{ old('jas_bb_6') }}" placeholder="kg"></td>
                                            </tr>
                                            <tr>
                                                <th>Tinggi Badan</th>
                                                <td><input type="number" min="1" name="jas_tb_1"
                                                        value="{{ old('jas_tb_1') }}" placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_2"
                                                        value="{{ old('jas_tb_2') }}" placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_3"
                                                        value="{{ old('jas_tb_3') }}" placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_4"
                                                        value="{{ old('jas_tb_4') }}" placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_5"
                                                        value="{{ old('jas_tb_5') }}" placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_6"
                                                        value="{{ old('jas_tb_6') }}" placeholder="cm"></td>
                                            </tr>
                                            <tr>
                                                <th>Penyakit</th>
                                                <td><input name="jas_pt_1" value="{{ old('jas_pt_1') }}" type="text">
                                                </td>
                                                <td><input name="jas_pt_2" value="{{ old('jas_pt_2') }}" type="text">
                                                </td>
                                                <td><input name="jas_pt_3" value="{{ old('jas_pt_3') }}" type="text">
                                                </td>
                                                <td><input name="jas_pt_4" value="{{ old('jas_pt_4') }}" type="text">
                                                </td>
                                                <td><input name="jas_pt_5" value="{{ old('jas_pt_5') }}" type="text">
                                                </td>
                                                <td><input name="jas_pt_6" value="{{ old('jas_pt_6') }}" type="text">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Keahlian Jasmani</th>
                                                <td><input name="jas_kj_1" value="{{ old('jas_kj_1') }}" type="text">
                                                </td>
                                                <td><input name="jas_kj_2" value="{{ old('jas_kj_2') }}" type="text">
                                                </td>
                                                <td><input name="jas_kj_3" value="{{ old('jas_kj_3') }}" type="text">
                                                </td>
                                                <td><input name="jas_kj_4" value="{{ old('jas_kj_4') }}" type="text">
                                                </td>
                                                <td><input name="jas_kj_5" value="{{ old('jas_kj_5') }}" type="text">
                                                </td>
                                                <td><input name="jas_kj_6" value="{{ old('jas_kj_6') }}" type="text">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <x-adminlte-card title="Meninggalkan Sekolah" class="col-md-12" theme-mode="full"
                        ...
                        <div class="row">
                            ...
                            {{-- Nomor Ijazah / STTB --}}
                            <x-adminlte-input name="no_ijazah" value="{{ old('no_ijazah') }}"
                            ...
                            {{-- Melanjutkan Ke Sekolah --}}
                            <x-adminlte-input name="lanjut_sekolah_pindah" value="{{ old('lanjut_sekolah_pindah') }}"
