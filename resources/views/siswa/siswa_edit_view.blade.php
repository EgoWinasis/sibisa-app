        ...
        <div class="container-fluid">
            ...
            <form method="POST" action="{{ route('siswa.update', $student->id) }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <x-adminlte-card title="Tahun Masuk" class="col-md-12" theme-mode="full">
                        <div class="row">
                            <div class="col-md-12">
                                <label for="angkatan">Angkatan</label>
                                <x-adminlte-input name="angkatan" value="{{ $student->angkatan }}" type="text"
                                    readonly>
                                </x-adminlte-input>
                            </div>
                        </div>
                    ...
                    <x-adminlte-card title="Keterangan Siswa" class="col-md-12" theme-mode="full" collapsible="collapsed">
                        <div class="row">
                            {{-- input form siswa --}}
                            {{-- NIS --}}
                            <x-adminlte-input name="nis" label="NIS"
                                value="{{ old('nis') ? old('nis') : $student->nis }}" placeholder="Nomor Induk Siswa"
                                type="number" fgroup-class="col-md-6">
                            </x-adminlte-input>
                            {{-- NISN --}}
                            <x-adminlte-input name="nisn" label="NISN"
                            ...
                            <x-adminlte-input name="nik" label="NIK"
                                value="{{ old('nik') ? old('nik') : $student->nik }}" placeholder="Nomor Induk Kependudukan"
                                type="number" fgroup-class="col-md-6">
                            </x-adminlte-input>
                            {{-- No. KK --}}
                            <x-adminlte-input name="no_kk" label="No. KK"
                                value="{{ old('no_kk') ? old('no_kk') : $student->no_kk }}"
                            ...
                            {{-- Nomor telepon --}}
                            <x-adminlte-input name="telepon"
                                value="{{ old('telepon') ? old('telepon') : $student->telepon }}" label="Nomor Telepon"
                            ...
                            {{-- Jarak --}}
                            <x-adminlte-input name="jarak" value="{{ old('jarak') ? old('jarak') : $student->jarak }}"
                                min="1" label="Jarak" placeholder="Kilometer" type="number"
                                fgroup-class="col-md-6">
                            </x-adminlte-input>
                    ...
                    <x-adminlte-card title="Keterangan Orang Tua / Wali Murid" class="col-md-12" theme-mode="full"
                        ...
                        <div class="row">
                            ...
                            <x-adminlte-input name="nama_ayah"
                                value="{{ old('nama_ayah') ? old('nama_ayah') : $orangTua->nama_ayah }}"
                                label="Nama Ayah" placeholder="Nama Ayah" fgroup-class="col-md-6" />
                            {{-- nama ibu --}}
                            ...
                            <x-adminlte-input name="nama_wali"
                                value="{{ old('nama_wali') ? old('nama_wali') : $orangTua->nama_wali }}"
                                label="Nama Wali" placeholder="Nama Wali" fgroup-class="col-md-6" />
                            {{-- Hubungan wali --}}
                    ...
                    <x-adminlte-card title="Perkembangan Siswa" class="col-md-12" theme-mode="full"
                        collapsible="collapsed">
                        <div class="row">
                            ...
                            @endphp
                            <x-adminlte-select name="tingkat_sekolah_pindah" label="Dari Tingkat"
                                fgroup-class="col-md-6">
                                <x-adminlte-options :options="$options" :selected="$selected" />
                            </x-adminlte-select>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered">
                                        <tbody>
                                            <tr>
                                                <th>Tahun</th>
                                                <td><input type="number" min="2000" name="jas_th_1"
                                                        value="{{ old('jas_th_1') ? old('jas_th_1') : $kesehatanJasmani->jas_th_1 }}">
                                                </td>
                                                <td><input type="number" min="2000" name="jas_th_2"
                                                        value="{{ old('jas_th_2') ? old('jas_th_2') : $kesehatanJasmani->jas_th_2 }}">
                                                </td>
                                                <td><input type="number" min="2000" name="jas_th_3"
                                                        value="{{ old('jas_th_3') ? old('jas_th_3') : $kesehatanJasmani->jas_th_3 }}">
                                                </td>
                                                <td><input type="number" min="2000" name="jas_th_4"
                                                        value="{{ old('jas_th_4') ? old('jas_th_4') : $kesehatanJasmani->jas_th_4 }}">
                                                </td>
                                                <td><input type="number" min="2000" name="jas_th_5"
                                                        value="{{ old('jas_th_5') ? old('jas_th_5') : $kesehatanJasmani->jas_th_5 }}">
                                                </td>
                                                <td><input type="number" min="2000" name="jas_th_6"
                                                        value="{{ old('jas_th_6') ? old('jas_th_6') : $kesehatanJasmani->jas_th_6 }}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Berat Badan</th>
                                                <td><input type="number" min="1" name="jas_bb_1"
                                                        value="{{ old('jas_bb_1') ? old('jas_bb_1') : $kesehatanJasmani->jas_bb_1 }}"
                                                        placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_2"
                                                        value="{{ old('jas_bb_2') ? old('jas_bb_2') : $kesehatanJasmani->jas_bb_2 }}"
                                                        placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_3"
                                                        value="{{ old('jas_bb_3') ? old('jas_bb_3') : $kesehatanJasmani->jas_bb_3 }}"
                                                        placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_4"
                                                        value="{{ old('jas_bb_4') ? old('jas_bb_4') : $kesehatanJasmani->jas_bb_4 }}"
                                                        placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_5"
                                                        value="{{ old('jas_bb_5') ? old('jas_bb_5') : $kesehatanJasmani->jas_bb_5 }}"
                                                        placeholder="kg"></td>
                                                <td><input type="number" min="1" name="jas_bb_6"
                                                        value="{{ old('jas_bb_6') ? old('jas_bb_6') : $kesehatanJasmani->jas_bb_6 }}"
                                                        placeholder="kg"></td>
                                            </tr>
                                            <tr>
                                                <th>Tinggi Badan</th>
                                                <td><input type="number" min="1" name="jas_tb_1"
                                                        value="{{ old('jas_tb_1') ? old('jas_tb_1') : $kesehatanJasmani->jas_tb_1 }}"
                                                        placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_2"
                                                        value="{{ old('jas_tb_2') ? old('jas_tb_2') : $kesehatanJasmani->jas_tb_2 }}"
                                                        placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_3"
                                                        value="{{ old('jas_tb_3') ? old('jas_tb_3') : $kesehatanJasmani->jas_tb_3 }}"
                                                        placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_4"
                                                        value="{{ old('jas_tb_4') ? old('jas_tb_4') : $kesehatanJasmani->jas_tb_4 }}"
                                                        placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_5"
                                                        value="{{ old('jas_tb_5') ? old('jas_tb_5') : $kesehatanJasmani->jas_tb_5 }}"
                                                        placeholder="cm"></td>
                                                <td><input type="number" min="1" name="jas_tb_6"
                                                        value="{{ old('jas_tb_6') ? old('jas_tb_6') : $kesehatanJasmani->jas_tb_6 }}"
                                                        placeholder="cm"></td>
                                            </tr>
                                            <tr>
                                                <th>Penyakit</th>
                                                <td><input name="jas_pt_1"
                                                        value="{{ old('jas_pt_1') ? old('jas_pt_1') : $kesehatanJasmani->jas_pt_1 }}"
                                                        type="text"></td>
                                                <td><input name="jas_pt_2"
                                                        value="{{ old('jas_pt_2') ? old('jas_pt_2') : $kesehatanJasmani->jas_pt_2 }}"
                                                        type="text"></td>
                                                <td><input name="jas_pt_3"
                                                        value="{{ old('jas_pt_3') ? old('jas_pt_3') : $kesehatanJasmani->jas_pt_3 }}"
                                                        type="text"></td>
                                                <td><input name="jas_pt_4"
                                                        value="{{ old('jas_pt_4') ? old('jas_pt_4') : $kesehatanJasmani->jas_pt_4 }}"
                                                        type="text"></td>
                                                <td><input name="jas_pt_5"
                                                        value="{{ old('jas_pt_5') ? old('jas_pt_5') : $kesehatanJasmani->jas_pt_5 }}"
                                                        type="text"></td>
                                                <td><input name="jas_pt_6"
                                                        value="{{ old('jas_pt_6') ? old('jas_pt_6') : $kesehatanJasmani->jas_pt_6 }}"
                                                        type="text"></td>
                                            </tr>
                                            <tr>
                                                <th>Keahlian Jasmani</th>
                                                <td><input name="jas_kj_1"
                                                        value="{{ old('jas_kj_1') ? old('jas_kj_1') : $kesehatanJasmani->jas_kj_1 }}"
                                                        type="text"></td>
                                                <td><input name="jas_kj_2"
                                                        value="{{ old('jas_kj_2') ? old('jas_kj_2') : $kesehatanJasmani->jas_kj_2 }}"
                                                        type="text"></td>
                                                <td><input name="jas_kj_3"
                                                        value="{{ old('jas_kj_3') ? old('jas_kj_3') : $kesehatanJasmani->jas_kj_3 }}"
                                                        type="text"></td>
                                                <td><input name="jas_kj_4"
                                                        value="{{ old('jas_kj_4') ? old('jas_kj_4') : $kesehatanJasmani->jas_kj_4 }}"
                                                        type="text"></td>
                                                <td><input name="jas_kj_5"
                                                        value="{{ old('jas_kj_5') ? old('jas_kj_5') : $kesehatanJasmani->jas_kj_5 }}"
                                                        type="text"></td>
                                                <td><input name="jas_kj_6"
                                                        value="{{ old('jas_kj_6') ? old('jas_kj_6') : $kesehatanJasmani->jas_kj_6 }}"
                                                        type="text"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                    ...
                    <x-adminlte-card title="Meninggalkan Sekolah" class="col-md-12" theme-mode="full"
                        ...
                        <div class="row">
                            ...
                            <x-adminlte-input-date label="Tahun Tamat" name="thn_tamat" :config="$config"
                                placeholder="Tahun Tamat" fgroup-class="col-md-6"
                                value="{{ old('thn_tamat') ? old('thn_tamat') : $meninggalkanSekolah->thn_tamat }}">
                                <x-slot name="appendSlot">
                                    <div class="input-group-text bg-gradient-danger">
                                        <i class="fas fa-calendar-alt"></i>
                                    </div>
                            ...
                            {{-- Nomor Ijazah / STTB --}}
                            <x-adminlte-input name="no_ijazah"
                                value="{{ old('no_ijazah') ? old('no_ijazah') : $meninggalkanSekolah->no_ijazah }}"
                                label="Nomor Ijazah / STTB" placeholder="Nomor Ijazah / STTB" fgroup-class="col-md-6" />
                            {{-- Melanjutkan Ke Sekolah --}}
                            <x-adminlte-input name="lanjut_sekolah_tamat"
                                value="{{ old('lanjut_sekolah_tamat') ? old('lanjut_sekolah_tamat') : $meninggalkanSekolah->lanjut_sekolah_tamat }}"
                            ...
                            {{-- Melanjutkan Ke Sekolah --}}
                            <x-adminlte-input name="lanjut_sekolah_pindah"
                                value="{{ old('lanjut_sekolah_pindah') ? old('lanjut_sekolah_pindah') : $meninggalkanSekolah->lanjut_sekolah_pindah }}"
                            ...
                            <x-adminlte-input-date label="Tanggal" name="tgl_keluar_sekolah" :config="$config"
                                placeholder="Tanggal" fgroup-class="col-md-6"
                                value="{{ old('tgl_keluar_sekolah') ? old('tgl_keluar_sekolah') : $meninggalkanSekolah->tgl_keluar_sekolah }}">
                                <x-slot name="appendSlot">
                                    <div class="input-group-text bg-gradient-danger">
                                        <i class="fas fa-calendar-alt"></i>
                                    </div>
                            ...
                            {{-- Alasan Keluar --}}
                            <x-adminlte-input name="alasan_keluar_sekolah"
                                value="{{ old('alasan_keluar_sekolah') ? old('alasan_keluar_sekolah') : $meninggalkanSekolah->alasan_keluar_sekolah }}"
                    ...
                    <x-adminlte-input-file id="imgInp" value="{{ old('foto_siswa') }}" name="foto_siswa"
                        label="Upload Foto" fgroup-class="col-md-6" placeholder="Choose a file..." />
                    <div class="col-md-7"></div>

                </div>
                <div class="row mt-2">
                    <div class="col-md-6 text-left">
                        <x-adminlte-button class="btn-flat text-light  " onclick="return back();" label="Kembali"
