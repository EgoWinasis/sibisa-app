            ...
            <div class="row">
                ...
                <x-adminlte-card class="col-md-12" theme-mode="full">
                    <div class="row">
                        ...
                        {{-- ijazah --}}
                        <x-adminlte-input-file name="ijazah" label="Ijazah" placeholder="Pilih file PDF (max 2MB)"
                        ...
                        {{-- SKHUN --}}
                        <x-adminlte-input-file name="skhun" label="SKHUN" placeholder="Pilih file PDF (max 2MB)"
                            fgroup-class="col-md-12" />
                        <div class="col-md-12">
                            <label class="font-italic text-success">File :
                        ...
                        {{-- SKL --}}
                        <x-adminlte-input-file name="skl" label="Surat Keterangan" placeholder="Pilih file PDF (max 2MB)"
                            fgroup-class="col-md-12" />
                        <div class="col-md-12">
                            <label class="font-italic text-success">File :
