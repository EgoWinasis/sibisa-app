...
@section('title', 'Ubah Pengaturan Siswa Tahun Ajaran {{ $tahunAjaran->tahun_ajaran }}')

@section('content_header')
    <h1 class="m-0 text-dark">Ubah Pengaturan Siswa Tahun Ajaran {{ $tahunAjaran->tahun_ajaran }}</h1>
@stop
...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            @endif
            <form method="POST" action="{{ route('atursiswa.update', $settingSiswa->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <a class="btn btn-success" title="Download Template"
                                            href="{{ asset('storage/template-kelas.xlsx') }}" download><i
