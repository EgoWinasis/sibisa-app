                ...
                <div class="row">
                    ...
                    <x-adminlte-card title="Data Siswa" class="col-md-12" theme-mode="full" collapsible="collapsed">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" value="{{ $ketidakhadiran->kelas }}" name="kelas"
                                    id="kelas" style="margin-top: 10px" type="text" readonly>
                    ...
                    <x-adminlte-card title="Tanda Tangan" class="col-md-12" theme-mode="full" collapsible="collapsed">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <x-adminlte-input-date value="{{ old('tgl_print') ? old('tgl_print') : $ttd->tgl_print }}"
