                ...
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a1b3c2"
                                                value="{{ old('a1b3c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a1b4c1"
                                                value="{{ old('a1b4c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a1b4c2"
                                                value="{{ old('a1b4c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a1b5c1"
                                                value="{{ old('a1b5c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a1b5c2"
                                                value="{{ old('a1b5c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a1b6c1"
                                                value="{{ old('a1b6c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a1b6c2"
                                                value="{{ old('a1b6c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b1c4"
                                                value="{{ old('a2b1c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">2.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b2c4"
                                                value="{{ old('a2b2c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">3.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b3c4"
                                                value="{{ old('a2b3c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">4.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b4c4"
                                                value="{{ old('a2b4c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">5.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b5c4"
                                                value="{{ old('a2b5c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">6.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b6c4"
                                                value="{{ old('a2b6c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b7c4"
                                                value="{{ old('a2b7c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b8c4"
                                                value="{{ old('a2b8c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b9c4"
                                                value="{{ old('a2b9c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b10c4"
                                                value="{{ old('a2b10c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b11c4"
                                                value="{{ old('a2b11c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b12c4"
                                                value="{{ old('a2b12c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a2b13c4"
                                                value="{{ old('a2b13c4') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a3b1c2"
                                                value="{{ old('a3b1c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">2.</td>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a3b2c2"
                                                value="{{ old('a3b2c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <x-adminlte-input name="a4b1c1"
                                                value="{{ old('a4b1c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a4b1c2"
                                                value="{{ old('a4b1c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">2.</td>
                                        <td>
                                            <x-adminlte-input name="a4b2c1"
                                                value="{{ old('a4b2c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a4b2c2"
                                                value="{{ old('a4b2c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="text-center">3.</td>
                                        <td>
                                            <x-adminlte-input name="a4b3c1"
                                                value="{{ old('a4b3c1') }}"></x-adminlte-input>
                                        </td>
                                        <td>
                                            <x-adminlte-input name="a4b3c2"
                                                value="{{ old('a4b3c2') }}"></x-adminlte-input>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <x-adminlte-card title="Tanda Tangan" class="col-md-12" theme-mode="full" collapsible="collapsed">
                        <div class="row">
                            ...
                            {{-- NIP kepala sekolah --}}
                            <x-adminlte-input name="nip_kepsek" value="{{ old('nip_kepsek') }}" label="NIP"
                            ...
                            <div class="col-md-12">
                                ...
                                <x-adminlte-input-date value="{{ old('tgl_print') }}" name="tgl_print" :config="$config"
