                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        @foreach ($kelas as $item)
                                            ...
                                            @endphp
                                            @if (empty($nilai))
                                                <a class="btn btn-info btn-kelas-empty"
                                                    style="cursor: not-allowed;opacity: 0.5;">{{ $item->kelas }}</a>
                                            @else
                                    ...
                                    @if (empty($kompetensi))
                                        <td class="text-center">
                                            <a class="btn btn-dark btn-kompetensi"
                                                style="cursor: not-allowed;opacity: 0.5;"><i class="fa fa-trophy"></i></a>
                                        </td>
                                    @else
                                        <td class="text-center">
                                    ...
                                    @if (empty($ijazah))
                                        <td class="text-center">
                                            <a class="btn btn-secondary btn-ijazah"
                                                style="cursor: not-allowed;opacity: 0.5;"><i class="fa fa-book"></i></a>
                                        </td>
                                    @else
                                        @php
                                        ...
                                        <td class="text-center">
                                            <a data-ijazah="{{ $ijazahValue }}" data-skl="{{ $sklValue }}"
                                                data-skhun="{{ $skhunValue }}"
                                                data-href="{{ route('cetak.ijazah', $ijazah->id) }}"
                                                data-href_skl="{{ route('cetak.skl', $ijazah->id) }}"
                                                data-href_skhun="{{ route('cetak.skhun', $ijazah->id) }}"
