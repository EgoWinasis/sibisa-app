                        ...
                        <div class="col-sm-8">
                            <x-adminlte-card title="Edit Profile Sekolah" theme="dark" icon="fas fa-lg fa-portrait">
                                ...
                                <x-adminlte-input name="alamat" label="Alamat"
                                    value="{{old('alamat')}}" />
                                <x-adminlte-input type="desa" name="desa" label="Desa / Kelurahan"
                                    value="{{old('desa')}}" />
                                <x-adminlte-input type="kecamatan" name="kecamatan" label="Kecamatan"
                                    value="{{old('kecamatan')}}" />
                                <x-adminlte-input type="kota" name="kota" label="Kota / Kabupaten"
                                    value="{{old('kota')}}" />
                                <x-adminlte-input type="provinsi" name="provinsi" label="Provinsi"
                                    value="{{old('provinsi')}}" />
